...
public interface IncidentRepository extends JpaRepository<Incident, Long> {
     ...
     * Recherche un incident non résolu (statut != RESOLU, CLOTURE, ANNULE) pour un véhicule donné.
     */
    ...
    /**
     * Détection de doublon par localisation et type (pour incidents sans vehiculeId).
